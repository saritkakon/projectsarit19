...
public class ShadowTests {
	...
	public void sphereTriangleInitial() {
		...
		scene.lights.add( //
				new SpotLight(new Color(400, 240, 0), new Point3D(-100, -100, 200), new Vector(1, 1, -3), 1, 1E-5,
						1.5E-7));
	...
	public void sphereTriangleChangingLight1() {
		...
		scene.lights.add( //
				new SpotLight(new Color(400, 240, 0), new Point3D(-80, -80, 150), new Vector(1, 1, -3), 1, 1E-5,
						1.5E-7));
	...
	public void sphereTriangleChangingLight2() {
		...
		scene.lights.add( //
				new SpotLight(new Color(400, 240, 0), new Point3D(-80, -80, 90), new Vector(1, 1, -3), 1, 1E-5,
						1.5E-7));
	...
	public void trianglesSphere() {
		...
		scene.lights.add( //
				new SpotLight(new Color(700, 400, 400), new Point3D(40, 40, 115), new Vector(-1, -1, -4), 1, 4E-4,
						2E-5));
